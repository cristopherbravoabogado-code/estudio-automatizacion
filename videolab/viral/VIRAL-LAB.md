...
"Qué video está en tendencia hoy, lo descargo, lo analizo, lo replico y lo publico de inmediato." Tarea diaria a las 10:00 Chile (`trig_012g4GgzsCQusrCuQPD439w3`): descubre el viral del día con números (cuentas semilla de TikTok y creadores legales chilenos por vistas/hora en las últimas 72 h; YouTube Shorts de los últimos 7 días por vistas/día; sonidos en tendencia CL vía Higgsfield si hay cuenta de TikTok conectada), lo radiografía con analizar.py, replica la ESTRUCTURA con contenido propio (quiz.py / ensayo.py / motor.py según la plantilla) y lo programa en Metricool en la primera franja libre ≥ 20 min después de terminar (misma mañana). Mide con Metricool (posts: views, fullVideoWatchedRate, forYou, sound, hashtag) los de días anteriores y ajusta la hora con getBestTimeToPostByNetwork los lunes. Registro: biblioteca.json ("tendencias_del_dia", "tendencia-<fecha>"), `viral/tendencias/`, bitácora, correo de 5 líneas. Límite honesto: el conector de Metricool no lista videos ajenos en tendencia (solo métricas propias y mejor hora), así que el descubrimiento va por yt-dlp y Higgsfield.
...
- "Tendencia del día" diaria 10:00 Chile (`trig_012g4GgzsCQusrCuQPD439w3`): viral del día → réplica → publicación la misma mañana.
