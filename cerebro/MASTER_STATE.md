...
> Última actualización: 5 de septiembre de 2026, 14:20 Chile (rev. 7 — F12 quiz legal en producción, viral-02). Copia fiel en Google Drive (Cerebro), doc 1ecVip4jbNuGeyCK3qvU9s_xiyKSwm4mCyKP124kdE34.
...
## 2. EL SISTEMA — estado al 05/09/2026 14:20
...
Ciclo diario: descubrir → radiografiar (`videolab/viral/analizar.py`) → extraer plantilla → adaptar → producir → publicar 21:30 → medir a 72 h. Biblioteca: `videolab/viral/biblioteca.json`. Análisis ejemplo: `videolab/ANALISIS-viral-01.md` (viral: corte cada 1,45 s, 4,7 palabras/s, anuncio de 36 s integrado como argumento). Viral-02 (05/09, lo mandó Cristopher: quiz de derecho estilo 'Neriquiz', 7 preguntas × 10 s, sin cortes, voz + tic-tac + ding) → formato **F12 Quiz legal**: `videolab/quiz.py` + `videolab/quiz_voces.py` (Pillow → ffmpeg, Kokoro, efectos sintetizados, US$0, ~3 min); piloto `videolab/piloto-quiz-01.json` ('7 preguntas que te pueden costar plata', 96 s, cada respuesta con artículo de ley). Análisis: `videolab/ANALISIS-viral-02.md`. Preguntas usadas: `videolab/viral/quizzes/`.

### VIDEO LAB (módulo de I+D audiovisual, encargado el 05/09/2026)
Carta: `videolab/VIDEO-LAB.md` · Auditoría 01: `videolab/AUDITORIA-2026-09-05.md` · Ranking vivo: `videolab/ranking.json` · Formatos-hipótesis F01-F12: `videolab/formatos.json`.
...
| Viral Lab | trig_018CyFgUac4dbAC5gpzic9o5 | diaria 15:00 | descubre 1 viral (YouTube Shorts / cuentas semilla de TikTok / lo que mande Cristopher), radiografía con viral/analizar.py, extrae plantilla, adapta guion, produce (pipeline v2 + ensayo.py, o quiz.py día por medio: F12) y programa a las 21:30 (quiz a las 20:00 si hay serie); mide a 72 h; bitácora + correo |
...
- PENDING dom 06/09: 371480046 control de identidad 09:00 (Kokoro) · 371367077 no ver al hijo 10:00 · 371367094 licencia rechazada 12:00 · 371480096 garantía arriendo 13:00 (Eleven) · 371367122 citación fiscalía 15:00 · 371367127 cobranza acoso 18:00 · 371472450 F11 parte 2 'el notario no es un juez' 21:30
- PENDING lun 07/09: **371526566 F12 quiz 'siete preguntas que te pueden costar plata' 20:00** (primer quiz; medir comentarios con puntaje) · parte 3 F11 pendiente para las 21:30 (la produce el Viral Lab del 06/09) · las 6 de la Fábrica del lunes dependen de que la plataforma ejecute la corrida de las 06:00 (verificación programada 06/09 07:40 Chile)
- Borrador técnico 371357009 (no publica; borrable)
- Temas ya usados (no repetir): fuero maternal, guardar silencio, pensión hasta qué edad, carta de despido, promesa de compraventa, retención de sueldo, finiquito firma con reserva, pensión impaga/arresto, detención de hijo/24 h, arriendo cambio de chapa, licencia rechazada/Compín, citación Fiscalía, relación directa y regular, cobranza/acoso, finiquito rápido/reserva/notario (serie F11), control de identidad/8 h, garantía de arriendo, quiz 01 (60 días hábiles, Ley Bustos, pensión hasta 28, 24 h ante el juez, 15 días de vacaciones, 40% pensión mínima, control de identidad 1 h)
...
D-01 marca de estudio · D-02 sin la cara de Cristopher · D-03 entretenido, sin tecnicismos · D-04 noticias rehechas en placa propia · D-05 descripción con teléfono, sitio, CTA y descargo · D-06 Metricool publica (Zernio respaldo) · D-07 autonomía total con regla de las tres vías · D-08 nada de clientes, RUT ni causas en herramientas · D-09 producción en el sandbox de Higgsfield, no en el Mac · D-10 (05/09, revisada 03:10) 6 publicaciones diarias en la grilla 09:00 12:00 13:00 16:00 18:00 20:00, con banco de fotos de gancho; subir volumen solo cuando los datos lo justifiquen · D-11 (05/09) VIDEO LAB: ninguna herramienta es imprescindible; prioridad gratis → open source → free tier → bajo costo → premium con datos; toda etapa con primaria, fallback y premium; un experimento a la vez · D-12 (05/09) karaoke palabra por palabra en todas las piezas (costo 0) · D-13 (05/09) VIRAL LAB: una pieza diaria a las 21:30 basada en la ESTRUCTURA de un viral ajeno (nunca su contenido), séptima franja del día; sube de volumen solo con datos · D-14 (05/09) F12 QUIZ LEGAL entra a producción por pedido de Cristopher ('copiemos este estilo'): día por medio en el Viral Lab, 7 preguntas nuevas con fuente legal verificada antes de renderizar, preguntas usadas registradas para no repetir; a 72 h se compara quiz vs ensayo y la estructura que gane se queda con más días
...
- Viral-02: cuando el original no está en línea (perfil vacío/privado), la radiografía se hace sobre el archivo con ffmpeg (cuadros cada 2 s, scene>0,3, envolvente y f0 del audio) y sin transcripción; sirve igual para extraer la estructura. Para VER un cuadro del sandbox desde el contenedor: jpg pequeño (216×384, q10, ~10 KB) → base64 en el stdout → decodificar en el contenedor; más de ~10 KB se trunca.
- Render por tubería (Pillow → ffmpeg rawvideo): 96 s de video en ~1 min con cuadros cacheados por estado; no generar PNG por cuadro.
...
- H-07 (05/09) el quiz F12 genera más comentarios y % completado que el ensayo F11 y que F01 → comparar a 72 h desde el 07/09 20:00; si gana, sube a diario
...
4. Formatos nuevos (E-03): 2 por semana desde `videolab/formatos.json`; matar bajo la mediana a 7 días. Serie F11 finiquito: parte 3 ('te pago en dos cuotas') la produce el Viral Lab el 06/09 para el 07/09 21:30; quiz 02 el 08/09.
